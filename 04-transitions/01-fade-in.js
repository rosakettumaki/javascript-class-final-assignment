;(function () {
    ...
    // Transition
      anno1.transition().duration(2000).attr("opacity", 1)
      anno2.transition().duration(2000).attr("opacity", 1)
    }
  })()
